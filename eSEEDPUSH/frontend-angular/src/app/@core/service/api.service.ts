...
import { APIData , Tag , Session , Request , CandicateSession , Profile , User , Employee, FileData , RequestData , Color , OfferedSlots , ReserveSlotBody , OfferSlotBody , Notification , ExpertAcceptSlotBody } from '../service/models/api.data.structure';
...
export class APIService {
  ...
  getEmployees(): Observable<APIData> {
    return this.http.get<APIData>(APIService.apiUrl + 'user/getEmployees').catch(this.errorHandler);
  }
  ...
  deleteEmployee(user: Employee): Observable<APIData> {
    console.log(user.email);
    return this.http.post<APIData>(APIService.apiUrl + '/user/deleteEmployee',user.email)
      .catch(this.errorHandler);
  }
